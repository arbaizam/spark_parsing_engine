...
_SPECIFIC_BEHAVIORS = {
    ParserType.STRING: [
        ...
        "title_business_v1 starts with title behavior, expands complete Yrs tokens to Years, canonicalizes its closed frequency vocabulary, hyphenates bounded integer Years/Months phrases, capitalizes the first lowercase letter in every non-empty component after an ASCII hyphen, and restores the frozen FHLB, P&I, UST, RCF, and CMT tokens.",
...
_SPECIFIC_GOTCHAS = {
    ParserType.STRING: [
        ...
        "property_type_v1 is fail-closed for unknown non-mixed full values; values containing the complete phrase Mixed Use instead retain their descriptors under the canonical Mixed Use - ... structure.",
