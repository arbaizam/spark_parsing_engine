...
| ST-003 | Domain display profiles | Bounded `title_business_v1` exceptions and numeric-hyphen casing, approved interest-rate canonicalization, and explicit preservation of an unknown interest-rate value materialize correctly. |
