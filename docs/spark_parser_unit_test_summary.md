...
The 0.5.0 release suite covers the scalar-only package contract and collects **156 pytest cases**:
**116 Spark-independent unit cases** and **40 Spark integration cases**. The Databricks system
